          ...
          context 'on RedHat like systems' do
            ...
            it do
              is_expected.to contain_package('omd-repository').with(
                ...
                :source   => "https://labs.consol.de/repo/stable/rhel#{facts[:operatingsystemmajrelease]}/#{facts[:architecture]}/labs-consol-stable.rhel#{facts[:operatingsystemmajrelease]}.noarch.rpm",
                :provider => 'rpm'
              )
            end
          ...
          context 'on Debian like systems' do
            ...
            it do
              is_expected.to contain_apt__source('omd').with(
                :location    => "http://labs.consol.de/repo/stable/#{facts[:operatingsystem].downcase}",
