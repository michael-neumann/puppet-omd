# == Class: omd::site::service_group
#
# This define creates a service group for a set of services/hosts.
#
# === Parameters
#
# [*site*]
...
# === Examples
#
# omd::site::service_group { 'fs_checks':
#   site               => 'default',
#   service_group_name => 'Filesystems',
#   host_tags          => 'webservers',
#   services           => ['fs'],
# }
#
# omd::site::service_group { 'all_checks':
#   site               => 'default',
#   service_group_name => 'Every check',
#   hosts              => ['ALL_HOSTS'],
...
define omd::site::service_group (
  ...
  validate_string($service_group_name)
  ...
  file { "${path}/${filename_real}":
    ...
    group   => $site,
    mode    => '0644',
    content => template('omd/service_groups.erb'),
